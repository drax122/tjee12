...
public final class pokazWszystkieDruzyny_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  for (Druzyna druzyna : storage.pokazWszystkieDruzyny()) {
	  out.println("<p>Nazwa: " + druzyna.getNazwaDruzyny() + "; Założyciel: " + druzyna.getmZalozyciel() + "</p>");
    }

      out.write("\r\n");
      out.write("<p>\r\n");
      out.write("  <a href=\"dodaj_druzyne.jsp\">Dodaj nową drużynę</a>\r\n");
      out.write("</p>\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
